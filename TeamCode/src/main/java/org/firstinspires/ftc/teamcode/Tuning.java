...
class LocalizationTest extends OpMode {
    @Override
    public void init() {
        Tuning.follower.setStartingPose(new Pose(72,72, -Math.PI/2));
    }
    ...
    public void loop() {
        ...
        Tuning.telemetryM.debug("front_right:" + hardwareMap.get(DcMotorEx.class,"front_right_drive").getVelocity());
        Tuning.telemetryM.debug("front_right:" + Tuning.follower.getDrivetrain());
        Tuning.telemetryM.update(telemetry);
